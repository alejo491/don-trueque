...
VALUES (1101,23,'DAVID','QUINTANA','1988-12-12',3124569876,'NOMBRE DE MI MADRE','BLANCA','davidq@unicauca.edu.co','quintana123','5268bb7ec4526d9decaae83ed5467d9f');/*davidquintana*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1102,45,'EDWAR','GIRALDO','1987-10-10',302409,'NOMBRE PERRO','BRUNO','edwargiraldo@unicauca.edu.co','alejo491','e3928a3bc4be46516aa33a79bbdfdb08');/*bruno*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1103,98,'LUIS','JIMENEZ','1978-05-12',321234324,'NOMBRE NOVIA','ISIS','lfjimenez@unicauca.edu.co','lfjimenez','7e1366c95782a8c6024e6d36269f72a2');/*jklssaas*/

INSERT INTO `usuario`
(`ID_USUARIO`,`tipo`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1104,'admin',21,'PAOLA','GIRON','1967-10-01',3123324324,'NOMBRE PERRA','DONA','paogiron@unicauca.edu.co','paolagiron','8cac6a2da5fcc359a24a9e4e5787f62d');/*dona*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1105,23,'JUAN','PINTO','1991-10-04',3153243234,'NOMBRE MADRE','EDITH','jdpinto@unicauca.edu.co','jdpinto','7a13315f5715a4b3be2e48feb5046e68');/*jdpinto*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1106,56,'FELIPE','ESCRIBANO','1988-11-11',3121232313,'ANIMAL FAVORITO','PANDA','fescribano@unicauca.edu.co','pandita123','5040fe8c4ac171fa06bb64f1dae2e723');/*ojeras*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1107,78,'ROBINSON','RAMOS','1990-09-01',3189998888,'NOMBRE DEPORTE','FUTBOL','rramos@unicauca.edu.co','miau','928591746dd16ebaa6cb7875a237786c');/*qwqsdaf*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1108,21,'CARLOS','BALDIVIESO','1979-08-09',3125677657,'COLOR FAVORITO','ROJO','cbaldivieso@unicauca.edu.co','baldi','39a6f7225f03b2071bb6ccf86c34a775');/*dfdsafdf*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1109,90,'ANDRES','VASQUEZ','1990-10-12',3123213212,'ANIMAL FAVORITO','GALLO','afvasquez@unicauca.edu.co','afvasquez','63a6d2db713cb4c41fda5c92dce66dc2');/*dsfasdsadddfds*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1110,45,'ISIS','PISO','1991-02-12',3123254534,'ANIMAL FAVORITO','TORTUGA','ipiso@unicauca.edu.co','isis12321','9d3ef7eabde43a3b65a7918c5325936d');/*asddssasd*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1111,65,'WALTER','ANTE','1990-07-10',3145546789,'MUSICA FAVORITA','MUSICA DE TOMAR','wante@unicauca.edu.co','fierroduro','a93bf9320377dc549341ba5e938a1ef8');/*343243*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1112,11,'FERNAANDO','BRAVO','1985-02-04',3123222222,'PROGRAMA FAVORITO','DRACULA','fbravo@unicauca.edu.co','fbravo','ce2bf5fbc11a813687da4820aa12dc1d');/*dsalklkl*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1113,18,'ANGELA','GUERRERO','1992-09-08',3187778888,'MATERIA FAVORITA','OPERATIVOS','aguerrero@unicauca.edu.co','aguerrero','b3ccfc0ed938795e4c31d94ac3934a2a');/*dsfds8989*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1114,45,'HAROLD','SILVA','1896-01-10',3158889992,'PASATIEMPO','SER UN VIVIDOR','hsilva@unicauca.edu.co','hsilva567','e1e5a18385df60ead4afe27ed4a25d30');/*ds989sdfjjc*/

INSERT INTO `usuario`
(`ID_USUARIO`,`ID_UBICACION`,`NOMBRE_USUARIO`,`APELLIDO_USUARIO`,`FECHA_N`,`TELEFONO`,`PREGUNTA`,`RESPUESTA`,`CORREO`,`NICK`,`PASS`)
VALUES (1115,98,'FRANSICO','REYES','1987-10-11',3124543321,'DONDE ESTUDIO','SENA','fereyes@unicauca.edu.co','pachito','eed0fb7ec72ce6b3316aa4b66066fb62');/*pachito456*/
...
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9001, 0101, 1101, 1115, 0115 ,'deseo intercambiar el articulo','2001/01/15');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9002, 0102, 1102, 1114, 0114 ,'deseo intercambiar el articulo','2001/02/12');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9003, 0103, 1103, 1113, 0113 ,'deseo intercambiar el articulo','2001/10/30');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9004, 0104, 1104, 1112, 0112 ,'deseo intercambiar el articulo','2002/10/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9005, 0105, 1105, 1111, 0111 ,'deseo intercambiar el articulo','2002/10/12');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9006, 0106, 1106, 1110, 0110 ,'deseo intercambiar el articulo','2003/05/11');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9007, 0107, 1107, 1109, 0109 ,'deseo intercambiar el articulo','2003/05/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9008, 0108, 1108, 1108, 0109 ,'deseo intercambiar el articulo','2003/09/20');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9009, 0109, 1109, 1107, 0107 ,'deseo intercambiar el articulo','2010/01/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9010, 0110, 1110, 1106, 0106 ,'deseo intercambiar el articulo','2010/01/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9011, 0111, 1111, 1105, 0105 ,'deseo intercambiar el articulo','2011/12/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9012, 0112, 1112, 1104, 0104 ,'deseo intercambiar el articulo','2012/12/20');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9013, 0113, 1113, 1103, 0103 ,'deseo intercambiar el articulo','2013/01/01');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9014, 0114, 1114, 1102, 0102 ,'deseo intercambiar el articulo','2013/02/20');
INSERT INTO `solicitud`(`ID_SOLICITUD`, `ID_ARTICULO`, `ID_USUARIO`, `USU_ID_USUARIO`, `ART_ID_ARTICULO`, `MENSAJE`,`FECHA_PROPUESTA`) VALUES (9015, 0115, 1115, 1101, 0101 ,'deseo intercambiar el articulo','2013/06/10');
